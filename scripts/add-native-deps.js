...
function insertNativeDependencies() {
    try {
        ...
        console.log(
            '[@teyuto/react-native-player] - native dependencies added to root package.json',
        );
    } catch (e) {
        // eslint-disable-next-line no-console
        console.log(
            `[@teyuto/react-native-player] - error adding dependencies to root package.json\n${e.message}`,
        );
        return;
    }
}
...
// eslint-disable-next-line no-console
console.log('[@teyuto/react-native-player] - adding native dependencies to root package.json');
